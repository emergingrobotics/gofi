...
type Network struct {
	...
	DHCPDLeaseTime      FlexInt `json:"dhcpd_leasetime,omitempty"`
	...
	WANEgressQOS         FlexInt          `json:"wan_egress_qos,omitempty"`
	WANLoadBalanceType   string           `json:"wan_load_balance_type,omitempty"`
	WANLoadBalanceWeight FlexInt          `json:"wan_load_balance_weight,omitempty"`
	...
	WANVLAN              FlexInt          `json:"wan_vlan,omitempty"`
	...
	LTEExtAnt FlexInt `json:"lte_ext_ant,omitempty"`
